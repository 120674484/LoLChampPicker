...
class HeroSelector(QMainWindow):
    ...
    def button3_click(self):
        heroes = ["冰霜女巫", "不祥之刃", "愁云使者", "大发明家", "符文法师", "光辉女郎", "海洋之灾","黑暗之女", "机械先驱", "九尾妖狐", "卡牌大师", "离群之刺", "诺克萨斯统领", "沙漠皇帝","邪恶小法师", "猩红收割者", "虚空行者", "岩雀", "影流之主", "远古巫灵", "正义巨像","冰晶凤凰", "皎月女神", "未来守护者", "百裂冥犬", "英勇投弹手", "异画师", "潮汐海灵",'诡术妖姬']
        self.label.setText(random.choice(heroes))
